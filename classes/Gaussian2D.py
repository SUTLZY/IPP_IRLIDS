...
class Gaussian2D():
    def __init__(self): 
        #self.rangeDistribs = (8,12)  # [6-16] 6 8 10 12 14 16  6zu
        self.rangeDistribs = (8,12) #(14,16)
        self.mean = []
        self.sigma_x = []
        self.sigma_y = []
        self.cov = []
    ...
    def addGaussian(self):
        ...
        gaussian_mean = np.random.rand(2) #均匀分布 高斯   #换几种分布
        gaussian_var = np.zeros((2, 2))
        gaussian_var[([0, 1], [0, 1])] = np.random.uniform(0.00005,0.0002,2)  # (0.0013,0.003,2) *2^5
